...
class BinTreeTester {
	...
	// 메뉴열거형
	enum Menu {
		ADD("삽입 "), REMOVE("삭제"), SEARCH("검색"), PRINT("오름차순 출력"), PRINTREVERSE("내림차순 출력"), 
		MINKEY("가장 작은 키"), MINKEYOFVALUE("가장 작은 키의 데이터"), MAXKEY("가장 큰 키"), MAXKEYOFVALUE("가장 큰 키의 데이터"),
		TERMINATE("종료");
	...
	public static void main(String[] args) {
		...
		do {
			...
			case SEARCH: // 노드의 검색
	          ...
	          case MINKEYOFVALUE :
	        	  System.out.println("============================================");
	        	  System.out.println(tree.getDataWithMinKey());
	        	  System.out.println("============================================");
	        	  break;
	          case MAXKEY :
	        	  System.out.println("============================================");
	          ...
	          case MAXKEYOFVALUE :
	        	  System.out.println("============================================");
	        	  System.out.println(tree.getDataWithMaxKey());
	        	  System.out.println("============================================");
	        	  break;  
			}
